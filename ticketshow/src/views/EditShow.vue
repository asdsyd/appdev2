...
onBeforeMount(()=>{
axios.get('/admin/'+movie_id.value+'/getShow').then(res=>{
if(res.data.length<=5){
const [name,showtags,showticketPrice,showstarttime,shwoendtime] = res.data
showName.value=name
tags.value = showtags.split(',')
ticketPrice.value=showticketPrice

startTime.value=showstarttime.slice(0,16)
